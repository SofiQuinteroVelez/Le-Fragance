...
from PyQt5.QtWidgets import QLabel, QMainWindow, QPushButton, QLineEdit, QAction


class Perfumeria1(QMainWindow):

    def __init__(self, ant):
        super(Perfumeria1, self).__init__()

        self.anterior = ant

        self.setWindowTitle("Inventario Perfumería 1")
        ...
        self.letrero2.setText("Carolina Herrera")
        ...
        self.letrero3.setText("One Million")
